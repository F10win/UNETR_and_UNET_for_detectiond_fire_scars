...
# -*- coding: utf-8 -*-
"""
Тестирование модели UNETR на новых снимках (11 каналов)
...
print("="*80)
print("🔥 ИНФЕРЕНЦИЯ МОДЕЛИ UNETR (11 КАНАЛОВ) НА НОВЫХ СНИМКАХ")
print("="*80)

# === НАСТРОЙКИ ===
MODEL_PATH = Path(r"E:\миигаик\1_Магистратура\Диплом\проект\UNETR_Burn\UNETR_Burn\UNETR_Burn\checkpoints\NewTrain\unetr_11ch_best.pth")
...
output_dir = Path(r"E:\миигаик\1_Магистратура\Диплом\проект\UNETR_Burn\UNETR_Burn\UNETR_Burn\analysis\inference_results_11ch") / f"result_{timestamp}"
...
plt.suptitle(f'🔥 Анализ гарей (11ch): {INPUT_IMAGE.name}', fontsize=18, fontweight='bold', y=0.995)
plt.tight_layout()
...
if not df.empty:
    ...
    with open(txt_path, 'w', encoding='utf-8') as f:
        f.write("="*80 + "\n")
        f.write("ОТЧЁТ: АНАЛИЗ ЛЕСНЫХ ГАРЕЙ (UNETR 11 КАНАЛОВ)\n")
        f.write("="*80 + "\n\n")
